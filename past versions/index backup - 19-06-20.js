...
bot.on('message', msg => {
    ...
    switch (args[0]) {
        ...
        case 'roll':
            ...
            if(number === 1) {
                msg.reply("sample text 1", {files: ["https://i.imgur.com/ZHc3qNV.png"]});
            }
            if(number === 2) {
                msg.reply("sample text 2", {files: ["https://i.imgur.com/cfjKUA3.png"]});
            }
            if(number === 3) {
                msg.reply("sample text 3", {files: ["https://i.imgur.com/DiI8kUD.png"]});
            }
            if(number === 4) {
                msg.reply("sample text 4", {files: ["https://i.imgur.com/G0aJB6s.png"]});
            }
            break;
        case 'reactionRules':
